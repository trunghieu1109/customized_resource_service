...
def launch_instance():
  instance = vast_sdk.launch_instance(num_gpus="1", gpu_name="RTX_3060", region="[VN]", image="pytorch/pytorch:2.1.2-cuda12.1-cudnn8-runtime",
  env='-p 8680:8680 -p 8081:8081')
  if instance:
    instance_id = get_instance_id(instance)
    ssh_addr, ssh_port = get_ssh_info(instance_id)
    return {
      "id": instance_id,
      "ssh_addr": ssh_addr,
      "ssh_port": ssh_port
